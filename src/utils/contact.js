...
// async function submitFormToGoogleScript(formData) {
//   try {
//     const proxyUrl = 'https://cors-proxy.p.rapidapi.com/proxy?url=';
//     const targetUrl = encodeURIComponent('https://script.google.com/macros/s/AKfycbx0B8818vXOoObv3G7B9rIJtsUS-M04HorqRH2O1Rk6_enLK_BSab1wvHjfZzwkukEHQw/exec');
  ...
  try {
    ...
    const requestOptions = {
      ...
      body: JSON.stringify({
        url: targetUrl,
        method: 'POST',
        body: formData, // Assuming formData is already an object
        headers: {
